import { Example, examples, inject } from "@opaquejs/testing";
...
const queryExamples: [(builder: QueryBuilder<typeof TestModel>) => QueryBuilder<typeof TestModel>, NormalizedQuery][] =
  [
    // Serialize
...
export class QueryBuilding {
  ...
  queryBuilding(
    @inject() modifier: Example<(builder: QueryBuilder<typeof TestModel>) => QueryBuilder<typeof TestModel>>,
    @inject() query: Example<NormalizedQuery>
  ) {
